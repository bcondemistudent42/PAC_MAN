...
config = {
    ...
    "pacman-dead-1": SpriteSheetPos(x=505, y=1, width=13, height=14),
    "pacman-dead-2": SpriteSheetPos(x=520, y=1, width=15, height=14),
    "pacman-dead-3": SpriteSheetPos(x=536, y=1, width=15, height=14),
    "pacman-dead-4": SpriteSheetPos(x=552, y=1, width=15, height=14),
    "pacman-dead-5": SpriteSheetPos(x=568, y=2, width=15, height=14),
    "pacman-dead-6": SpriteSheetPos(x=584, y=2, width=15, height=14),
    "pacman-dead-7": SpriteSheetPos(x=601, y=4, width=13, height=14),
    "pacman-dead-8": SpriteSheetPos(x=619, y=4, width=9, height=14),
    "pacman-dead-9": SpriteSheetPos(x=637, y=4, width=5, height=14),
    "pacman-dead-10": SpriteSheetPos(x=655, y=4, width=1, height=14),
    "pacman-dead-11": SpriteSheetPos(x=666, y=4, width=11, height=14),
